...
Public Class Voiture_Moyenne

    Private Sub Voiture_Moyenne_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        DGV2.Columns(1).HeaderText = "Nom de voiture"
        ...
        cmd = New MySqlCommand("select  Mat_voiture,Nom_voiture,Date_mise_circulation,Nombre_place,boite_vitess,carburant,Puissance,Compteur,Disponibilite,Nom_Image,prix,Libelle_categ from voiture,categorie where voiture.code_categ=categorie.code_categ and categorie.Code_categ=2 and disponibilite='OUI'", con)
    ...
    Private Sub DGV2_SelectionChanged1(sender As Object, e As EventArgs) Handles DGV2.SelectionChanged
        Try
