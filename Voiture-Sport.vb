...
Public Class Voiture_Sport

    Private Sub Voiture_Sport_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        cmd = New MySqlCommand("select  Mat_voiture,Nom_voiture,Date_mise_circulation,Nombre_place,boite_vitess,carburant,Puissance,Compteur,Disponibilite,Nom_Image,prix,Libelle_categ from voiture,categorie where voiture.code_categ=categorie.code_categ and categorie.Code_categ=5", con)
