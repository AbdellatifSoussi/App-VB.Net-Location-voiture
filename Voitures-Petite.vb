...
Public Class Minis_Voitures

    'Public Function existe(ByVal x As Integer) As Integer
    '    Dim i As Integer
    '    For i = 0 To n
    '        If Matricule.Text = x Then
    '            Return i
    '        End If
    '    Next
    '    Return -1
    ...
    'Sub Afficher()
    '    If n = 0 Then
    '        PICTBOX.Image = Image.FromFile(Application.StartupPath & "/images/" & "Citroën C1.jpg")
    ...
    Private Sub Minis_Voitures_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        cmd = New MySqlCommand("select  Mat_voiture,Nom_voiture,Date_mise_circulation,Nombre_place,boite_vitess,carburant,Puissance,Compteur,Disponibilite,Nom_Image,prix,Libelle_categ from voiture,categorie where voiture.code_categ=categorie.code_categ and categorie.Code_categ=1 and disponibilite='OUI'", con)
