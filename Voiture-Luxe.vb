...
Public Class Voiture_Luxe

    Private Sub Voiture_Luxe_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        cmd = New MySqlCommand("select  Mat_voiture,Nom_voiture,Date_mise_circulation,Nombre_place,boite_vitess,carburant,Puissance,Compteur,Disponibilite,Nom_Image,prix,Libelle_categ from voiture,categorie where voiture.code_categ=categorie.code_categ and voiture.Code_categ=4 and disponibilite='OUI'", con)
